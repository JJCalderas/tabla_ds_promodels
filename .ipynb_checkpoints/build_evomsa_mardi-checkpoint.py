...
def process(fn):
    ...
    for i, sample in df_samples.iterrows():   ### [:3] [8:9]
        try:
            ...
            sample_avoid = sample_avoid.dropna().values[sample_avoid.dropna().values != 'haha18']
...
fnames = glob("dataset_es/haha21_Es_train.json") ## todos los train datasets
fnames.sort()
results = []
...
results_df.to_csv('results_full_77.csv')
#results_df
